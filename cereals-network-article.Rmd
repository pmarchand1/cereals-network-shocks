...
We note that the average of $\Delta s_{rel}$ may be greater or less than -1 depending on the covariance between $\Delta s_{rel}$ and the initial supply $S_0$. Starting from eq. \ref{eq:dsrel}, we can calculate:
\begin{align} 
