...
To compare simulation results across different versions of the trade network, we fix the global simulation parameters to $f_p = 0.2$ (20% production decrease in the country initiating the shock), $f_r = 0.5$ (50% of reserves available to buffer shocks) and $f_c = 0.01$ (1% of residual shock absorbed by consumption before it is passed through trade). A sensitivity analysis of the simulation results to changes in these parameters can be found in the supplementary materials.
